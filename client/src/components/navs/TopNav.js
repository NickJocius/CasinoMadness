                ...
                <div className={`bg-black md:flex md:justify-end md:w-full md:flex-shrink w-full text-center`}>
                    {!user && (
                        <>
                            ...
                            <Link to="#" className="block md:inline-block text-white hover:text-red-blood px-3 py-3 border-b-2 border-red-blood md:border-none font-bangers">Register</Link>
                        </>
                    )}
                    {user && (
